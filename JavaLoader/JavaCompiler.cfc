	...
	<cfscript>
		...
		catch(any exc)
		{
			...
			try
			{
			   ...
			   data.compiler = loader.create("com.sun.tools.javac.api.JavacTool");
...
<cffunction name="compile" hint="compiles Java to bytecode, and returns a JAR" access="public" returntype="any" output="false">
	...
	<cfloop array="#arguments.directoryArray#" index="directoryToCompile">
		<cfdirectory action="list" directory="#directoryToCompile#" name="qFiles" recurse="true" filter="*.java" type="all">
